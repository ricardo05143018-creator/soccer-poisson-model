"""
Poisson soccer model v1.6.2
Strict 90-minute data with convergence-terminated iterative scaling.
Refactored for dual-match inference (France vs Spain & Argentina vs England).
Date: July 2026
"""
...
# iterative scaling with relaxation
...
for round_idx in range(MAX_ITERATIONS):
    ...
    # apply damping to stop oscillations
...
if __name__ == "__main__":
    print(f"[BOOT] Loaded v1.6.2 | Dual-match inference module active")
